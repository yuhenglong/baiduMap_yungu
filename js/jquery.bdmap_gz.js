	...
	*/
	...
	function createMapPoint(dataJson, paramJson) {
	    ...
	    var l_point = dataJson.l_point,
	        ...
	        image = dataJson.image, //定义图片
	        visitor_count = dataJson.visitor_count, //人流量
	        equipment = dataJson.equipment, //设备台数
	    ...
	    // 世杰需求start
	    // var point_yu = new BMap.Point(113.343039, 23.158247); // 设置中心点
	    // map.centerAndZoom(point_yu, 14);

	    // var circle_yu = new BMap.Circle(point_yu, 5000, {
	    //     strokeColor: "blue",
	    //            //边线颜色。  
	    //                 fillColor: "none",
	    ...
	    // }); //设置覆盖物的参数，中心坐标，半径，颜色
	    // map.addOverlay(circle_yu); //在地图上显示圆形覆盖物
	    // // 第二个圆

	    // var point_yu_two = new BMap.Point(113.343037, 23.158248); // 设置中心点
	    // map.centerAndZoom(point_yu_two, 14);
	    // var circle_yu_two = new BMap.Circle(point_yu_two, 3000, {
	    //     strokeColor: "red",
	    //            //边线颜色。  
	    //                 fillColor: "",
	    //              //填充颜色。当参数为空时，圆形将没有填充效果。  
	    ...
	    // map.addOverlay(circle_yu_two); //在地图上显示圆形覆盖物
	    // 世杰需求end
	...
	function createMapInfoWindow(marker, json, isPCequipt) {
	    ...
	    var infoOptionsPc = {
	            ...
	            "height": 550, //信息窗高度(60-650) 0 自动调整
